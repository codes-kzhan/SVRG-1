...
subOptDIG = DIG(logCost, Xtrain, ytrain, Xtest, ytest, passes, factorDIG, dataset, gridNum, ourlimit);
...
save(filename, 'subOpt', 'subOptNR', 'subOptK', 'subOptIAG', 'subOptDIG', 'subOptKatyusha');
