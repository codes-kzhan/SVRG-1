...
filename = strcat('../data/', dataset, '_result_4_1e-8.mat');
% load(filename);

% subOptDIG = DIG(logCost, Xtrain, ytrain, Xtest, ytest, passes, factorDIG, dataset, gridNum);
...
save(filename, 'subOpt', 'subOptNR', 'subOptK', 'subOptIAG');
