function subOptimality = svm_KatyushaNR(objFunc, X, y, Z, ZT, Xtest, ytest, passes, factor, batchSize, dataset, gridNum, ourlimit)
...
for s = 1:passes % for each epoch
    ...
    SIGM_svm(w, wtilde, ntilde, Z, lambda, alpha, iterNum, u, z, tau1, tau2);
    wtilde(:) = u(:);
